Ext.define('RadioCloudPortal.model.sensor.RSSIData', {
    ...
    proxy: {
    		...
    		url: RadioCloudPortal.MyGlobal.url + 'SensorData?sensor.sensorType_id=8&max=10&sort=dateCreated&order=desc'
    }    

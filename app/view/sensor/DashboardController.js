Ext.define('RadioCloudPortal.view.sensor.DashboardController', {
...
*/
    onNodeChange: function (record) {
    	...
    	Ext.getStore("sensor.TiltData").filterByNode(record.get('node_id'));
    	Ext.getStore("sensor.GarbageData").filterByNode(record.get('node_id'));
    	Ext.getStore("sensor.SoilMoistureData").filterByNode(record.get('node_id'));
    	Ext.getStore("sensor.MotionData").filterByNode(record.get('node_id'));

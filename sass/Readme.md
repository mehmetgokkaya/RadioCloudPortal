...
folder are mapped to the application's root namespace, 'RadioCloudPortal'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "RadioCloudPortal"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'RadioCloudPortal' in the same way
as `"RadioCloudPortal/sass/src"`.
